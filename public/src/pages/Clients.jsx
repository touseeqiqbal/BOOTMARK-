                                    ...
                                    return (
                                        <div key={client.id} className="form-card" style={{ cursor: 'pointer', position: 'relative' }}>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px', paddingLeft: '32px' }}>
                                                <div style={{ flex: 1 }}>
                                                    <h3 style={{ margin: 0, fontSize: '18px', marginBottom: '6px' }}>{client.name}</h3>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid #e5e7eb' }}>
                                                {!client.accountCreated && client.email && (
                                                    <button
                                                        className="btn btn-sm"
                                                        onClick={async (e) => {
                                                            e.stopPropagation()
                                                            if (confirm(`Resend invitation email to ${client.email}?`)) {
                                                                try {

...
import { ArrowLeft, User, Lock, Bell, Building, Save, Mail, CreditCard, CheckCircle, XCircle, Loader, AlertCircle, RefreshCw, Settings } from 'lucide-react'
  ...
  return (
    <div className="account-settings">
      ...
      <div className="container">
        ...
        {/* Quick Access to Number Format Settings */}
        <div style={{
          padding: '16px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ margin: 0, fontSize: '13px', opacity: 0.9 }}>
                Customize numbering for work orders, invoices, clients, and more
              </p>
            </div>

        ...
        {!showVerificationMessage && (
          <div style={{
            ...
            >
              ...
              <div style={{ fontSize: '12px', color: '#6b7280' }}>Create business account</div>
            </div>
            ...
            >
              ...
              <div style={{ fontSize: '12px', color: '#6b7280' }}>Create client account</div>
            </div>
          </div>
        )}
        ...
        {!showVerificationMessage && (
          <form onSubmit={handleSubmit} autoComplete="on">
            ...
            <button type="submit" className="btn btn-primary" disabled={loading}>
              {loading ? 'Creating account...' : `Sign up as ${role === 'admin' ? 'Business Owner' : 'Client'}`}
            </button>
          </form>
        )}
